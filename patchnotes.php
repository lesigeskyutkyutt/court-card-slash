...
// Fetch patch notes from database
...
<head>
    ...
    <title>Patch Notes - Court Card Slash</title>
    <link rel="stylesheet" href="patchnotes-styles(1).css">
        ...
        <?php if ($result && $result->num_rows > 0): ?>
            <?php while($row = $result->fetch_assoc()): ?>
                <div class="version-card">
                    <h2>Version <?php echo htmlspecialchars($row['version']); ?></h2>
                    <div class="release-date">Released: <?php echo date('F j, Y', strtotime($row['release_date'])); ?></div>
                    <div class="download-section">
                        <?php if(isset($_SESSION['user_id'])): ?>
                            <a href="<?php echo htmlspecialchars($row['download_link']); ?>" class="download-btn" download>Download Game (v<?php echo htmlspecialchars($row['version']); ?>)</a>
                        <?php else: ?>
                            <a href="#" onclick="showLogin()" class="download-btn">Login to Download</a>
                        <?php endif; ?>
                    </div>
                    <div class="changes">
                        <h3>Features:</h3>
