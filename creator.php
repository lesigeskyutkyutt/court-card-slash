...
<head>
    ...
    <title>Creators - Court Card Slash</title>
...
<body>
    ...
    <div class="creators-section">
        ...
        <div class="creators-grid">
            ...
            <div class="creator-card">
                ...
                <h2>John Andy Abarca</h2>
                <p class="role">Game Developer</p>
                <p class="bio">Passionate about game development and creating immersive experiences.</p>
            </div>
            ...
            <div class="creator-card">
                ...
                <p class="bio">Specializing in game mechanics and user experience design.</p>
            </div>
            ...
            <div class="creator-card">
                ...
                <h2>Angelo Lesiges</h2>
                <p class="role">Co-Developer</p>
                <p class="bio">Creating stunning visuals and character designs.</p>
            </div>
    ...
    <footer>
        <div class="footer-content">
            <p>&copy; 2024 Court Card Slash. All rights reserved.</p>
            <nav>
